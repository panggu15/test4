...
def main(args):
    ...
    if args.gradient_checkpointing:
        image_proj_model.enable_gradient_checkpointing()
    ...
    # Optimizer creation
    params_to_optimize = image_proj_model.parameters()
    ...
    image_proj_model, optimizer, train_dataloader, lr_scheduler = accelerator.prepare(
        image_proj_model, optimizer, train_dataloader, lr_scheduler
    )
